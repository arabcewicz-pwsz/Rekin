        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="edit" style="padding: 5px">
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_student/edit/do_update/'.$row['student_id'] , array('class' => 'form-horizontal validatable'));?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <a href="<?php echo base_url();?>index.php?admin/manage_student/edit/<?php echo $row['student_id'];?>"
                                ...
                                <a href="<?php echo base_url();?>index.php?admin/manage_student/delete/<?php echo $row['student_id'];?>" onclick="return confirm('delete?')"
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_student/create/' , array('class' => 'form-horizontal validatable'));?>
